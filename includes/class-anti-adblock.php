...
class Anti_AdBlock {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Anti_AdBlock_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Anti_AdBlock_Loader. Orchestrates the hooks of the plugin.
	 * - Anti_AdBlock_i18n. Defines internationalization functionality.
	 * - Anti_AdBlock_Admin. Defines all hooks for the admin area.
	 * - Anti_AdBlock_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-anti-adblock-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-anti-adblock-i18n.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-anti-adblock-public.php';

		$this->loader = new Anti_AdBlock_Loader();
	 ...
	 *
	 * Uses the Anti_AdBlock_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Anti_AdBlock_Public($this->get_plugin_name(), $this->get_plugin_slug(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Anti_AdBlock_Loader    Orchestrates the hooks of the plugin.
	 */
